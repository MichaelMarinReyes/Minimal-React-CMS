...
"string"                               { System.out.println(yytext());return new Symbol(ParserSym.STRING, yyline+1, yycolumn+1, yytext()); }
...
"boolean"                              { return new Symbol(ParserSym.BOOLEAN, yyline+1, yycolumn+1, yytext()); }
...
\'                                     { return new Symbol(ParserSym.COMILLA_SIMPLE, yyline+1, yycolumn+1, yytext()); }
...
"#"[a-zA-Z0-9 ]+\n                     { return new Symbol(ParserSym.COMENTARIO_TOML, yyline+1, yycolumn+1, yytext()); }
